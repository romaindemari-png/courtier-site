...
ADMIN = {
    ...
    # Formulaire (libellés statiques de la page)
    "form_legend":     "Créer / éditer une brève",
    "form_date":       "Date",
    "form_type":       "Type",
    "form_titre":      "Titre",
    "form_corps":      "Corps",
    "form_lien":       "Lien (optionnel)",
    "form_epingle":    "Épingler",
    "form_publie":     "Publié (en ligne)",
    "save":            "Enregistrer",
    "cancel":          "Annuler l'édition",
    "list_title":      "Toutes les brèves",
    "adblock_hint":    "Si un bouton ne répond pas, désactivez votre bloqueur de publicité sur ce site.",
    # Actions / messages (injectés vers admin.js via #admin-config)
    "act_edit":        "Éditer",
    "act_publish":     "Publier",
    "act_unpublish":   "Dépublier",
    "act_delete":      "Supprimer",
    "confirm_delete":  "Supprimer définitivement cette brève ? Action irréversible.",
    "saving":          "Enregistrement…",
    "saved_create":    "Brève créée.",
    "saved_update":    "Brève mise à jour.",
    "saved_publish":   "Statut mis à jour.",
    "saved_delete":    "Brève supprimée.",
    "save_error":      "Échec de l'enregistrement.",
    "need_title":      "Le titre est obligatoire.",
    "need_type":       "Choisissez un type.",
    "need_date":       "La date est obligatoire.",
    "bad_link":        "Lien invalide (http/https uniquement).",
}
